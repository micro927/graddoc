...
<div class="invalid-feedback">กรุณากรอกเลขหน่วยงาน</div><?php }else{?><input name="fac_code"  id="fac_code" class="form-control" type="text" value="<?="อว ".$fac_doc_code[0]?>" placeholder="เลขหน่วยงาน" readonly required>
<?php }?>