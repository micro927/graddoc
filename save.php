...
$fac_id = $_POST['fac_id'];
$fac_code = $_POST['fac_code']; //if others
$from_sub_num = ($fac_id=='999') ? "" : $_POST['from_sub_num'];
$from_run_num = ($fac_id=='999') ? "" : $_POST['from_run_num'];
$fac_code_full = $_POST['fac_code'].$_POST['from_sub_num'].'/'.$_POST['from_run_num'];
...
$sql_check = "SELECT reg_num FROM doc WHERE (reg_num='$reg_num' OR gra_num='$gra_num') AND year_show='$doc_year'+543";
...
$sql_insert_others_fac = "INSERT INTO others_fac(reg_num,year_show,fac_name,fac_code_full)
                            VALUES('$reg_num','$doc_year'+543,'$tips','$fac_code_full')";
$sql_insert_tips = "INSERT INTO tips(reg_num,tips,year_show)
            VALUES('$reg_num','$tips','$doc_year'+543)";               
