...
if(strlen($_POST["datepicker"])==10){
    $doc_year = substr($_POST["datepicker"],6,4);
    $doc_month = substr($_POST["datepicker"],3,2);
    $doc_day = substr($_POST["datepicker"],0,2);
...
$sql = "SELECT * FROM doc WHERE date LIKE '$report_date%' AND staff_id LIKE '%$staff_id'";
...
<!-- Show Result -->
    <h4 id="table_title" align="center"> <?=$num_rows?> เรื่อง</h4>
<!-- Table -->
