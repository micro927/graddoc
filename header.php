  ...
  <div class="position-fixed fixed-top">
    <nav class="navbar navbar-primary bg-primary justify-content-center">
      <ul class="nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="edit.php?get_year_show=<?=$year_show?>">บันทึก</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="report.php?get_year_show=<?=$year_show?>">รายงาน</a>
        </li>
        <div class="btn-group">
